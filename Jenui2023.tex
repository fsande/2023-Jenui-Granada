...
\end{quote}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% 
y con ella, el bot entrega una solución que es aceptada (AC) por \jutge{} pero que no cumple algunos de los
...
\item ¿Qué cambios debemos introducir en nuestra práctica docente de la enseñanza de la programación?
