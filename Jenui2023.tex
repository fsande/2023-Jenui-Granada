...
%	framesep=4pt,
%	%frameround=ftt,			% BGD: Cuadro con esquina curvadas
%  %framextopmargin=3pt,
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\lstinputlisting[float=*h, caption={Contenido del fichero \texttt{box.cc} generado por \ChatGPT{}}, label=code:boxc]{box1.cc}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
Este trabajo está financiado por el Ministerio de Ciencia e Innovacióna través de los proyectos 
