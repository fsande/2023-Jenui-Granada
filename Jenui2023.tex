...
%\affil[2]{\texttt{fsande@ull.es}, \texttt{plopez@iac.es}}
...
%\begin{tabular}{c}
%%\lstinputlisting[float=*t, caption={Contenido del fichero \texttt{box.cc} generado por \ChatGPT{}}, label=code:boxc]{box1.cc}
%\lstinputlisting[caption={Contenido del fichero \texttt{box.cc} generado por \ChatGPT{}}, label=code:boxc]{box1.cc}
%\end{tabular}
%\end{center}
%\end{table*}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
