...
(ASIG, de ahora en adelante) es la primera asignatura en la que el alumnado toma 
...
orientado a objetos, que es el paradigma objeto de estudio en ASIG.

ASIG es una asignatura de 6 créditos que se imparte en el primer cuatrimestre 
...
alumnado en la materia de Programación, siendo C++ el lenguaje vehicular utilizado para estudiarla.
...
Siguiendo esta idea, recomendamos encarecidamente al alumnado de ASIG que realice cuantos ejercicios prácticos
...
Desde hace ya varios cursos en ASIG se viene usando la plataforma \jutge{} (juez) 
...
\jutge{} comprueba exclusivamente que el código evaluado funcione correctamente, mientras que en ASIG se
...
Muchos de los requisitos que se exigen a los programas de prácticas de ASIG se definen en la Guía de estilo de 
...
de la realización de prácticas de ASIG.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% Section %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% 
...
Se ha intentado describir los problemas tanto en inglés (idioma en que están descritos la mayoría de
...
%        {\small
%        \begin{itemize}
%          \item Base su solución en una función que será invocada desde \textit{main()}.
...
El listado \ref{} muestra el contenido del fichero \texttt{box.cc} en el que se han eliminado los comentarios
en formato \textit{Doxigen} que el bot incluía antes de cada una de las funciones.
%%%%%%%%%%%%%%%%% Code %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%\lstinputlisting[float=*t, caption={Declaración de la clase \textit{Box}}, label=code:boxh]{2.h}
\lstinputlisting[caption={Declaración de la clase \textit{Box}}, label=code:boxh]{box1.h}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
Como muestran los experimentos reflejados en la sección anterior, la capacidad de resolver problemas sencillos
de programación como los que se utilizan en los primeros cursos del Grado en Ingeniería Informática es
sobresaliente.
Podemos afirmar que \ChatGPT{} es capaz de resolver correctamente la mayoría de los problemas especificados en
