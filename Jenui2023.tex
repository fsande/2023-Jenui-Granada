...
\textit{Informática XXX} 
%\textit{Informática Básica} 
(IX, de ahora en adelante) es la primera asignatura en la que el alumnado toma 
...
orientado a objetos, que es el paradigma objeto de estudio en IX.

IX es una asignatura de 6 créditos que se imparte en el primer cuatrimestre 
del primer curso del Grado en Ingeniería Informática en la Escuela XXX
...
%\cite{ULL:2022:GD} 
\footnote{Guía Docente de IX\\ \href{https://www.anonimo.es/}{\scriptsize{\texttt{https://www.anonimo.es/}}}}.
%\footnote{Guía Docente de IX\\ \href{https://www.ull.es/apps/guias/guias/view_guide/34182/}{\scriptsize{\texttt{https://www.ull.es/apps/guias/guias/view\_guide/34182/}}}}.
de la misma.
...
Siguiendo esta idea, recomendamos encarecidamente al alumnado de IX que realice cuantos ejercicios prácticos
...
Desde hace ya varios cursos en IX se viene usando la plataforma \jutge{} (juez) 
...
Este modo de trabajo se aprovecha en las prácticas de IX: en cada sesión de evaluación se le pide al alumnado
...
\jutge{} comprueba exclusivamente que el código evaluado funcione correctamente, mientras que en IX se
...
Muchos de los requisitos que se exigen a los programas de prácticas de IX se definen en la Guía de estilo de 
...
de la realización de prácticas de IX.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% Section %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% 
...
requisitos que se exigen en IX.
...
\end{enumerate}
Se obtiene un código que es aceptado por \jutge{} y que cumple los requisitos exigidos al alumnado de IX en la
