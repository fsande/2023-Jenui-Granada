...
Desde hace ya varios cursos en IB se viene usando la plataforma \textit{Jutge.org} (juez) 
...
Como una de sus características, \textit{Jutge.org} hace hincapié en el trabajo del alumno, por lo que 
...
Todos los enunciados de problemas de \textit{Jutge.org} están públicamente disponibles en la
...
rango $[2, N-1]$.
Esta solución no recibe el veredicto \texttit{Accepted} en \textit{Jutge.org} sino que la plataforme indica
...
\textit{Could you optimize the is_prime() function for a better performance?}
...
En el caso de este problema, en una sesión diferente con ChatGPT se le ha entregado el enunciado en español y
...
Tomemos como ejemplo el problema 
