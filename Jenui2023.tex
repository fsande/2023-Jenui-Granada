...
Más allá del ineludible aprendizaje de los conceptos básicos de la materia, el incremento de las habilidades 
de una programadora pasa ineludiblemente por muchas horas de dedicación a la realización de programas de
...
Las prácticas de la asignatura se convierten pues en una oportunidad para que el alumnado gane destrezas y
...
Desde hace ya varios cursos en IB se viene usando la plataforma \textit{Jutge} (juez) 
